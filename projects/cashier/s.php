					...
					<ul class="nav" id="main-menu">
						...
						<li style="font-size: 16px;">
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a class="active-menu" href="s.php">BAR</span></a>
								</li>
							</ul>
						  </li>  
										...
										<div class="table-responsive">
											<?php  
												include "tableS.php";
													...
													$query = "SELECT table_name,table_column FROM table_db where table_column ='S' order BY table_name";
...
FRAG;
																	   echo'<form name="billform" id="form'.$table_no.'" action="s.php" method="post" onsubmit="return check_alert()">';
