					...
					<ul class="nav" id="main-menu">
						...
						<li style="font-size: 16px;">
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a class="active-menu" href="c.php">C Tables</span></a>
								</li>
								<li>
										...
										<div class="table-responsive">
											<?php  
												include "tableC.php";
													...
													$query = "SELECT table_name,table_column FROM table_db where table_column ='C' order BY table_name";
																			...
																			<script>
																					function adminprompt(){
																						...
																						if (pass != null && pass == $pass) {
																							window.location.href='deleteC.php';
																						}else{
...
FRAG;
																	   echo'<form name="billform" id="form'.$table_no.'" action="c.php" method="post" onsubmit="return check_alert()">';
																											...
																											if($result){	
																												echo
																													("<SCRIPT LANGUAGE='JavaScript'>
																													 ...
																													 window.location.href='changeC.php';
																													</SCRIPT>");	
																											}
																										}
																									} 
