					...
					<ul class="nav" id="main-menu">
						...
						<li style="font-size: 16px;">
							...
							<ul class="nav nav-second-level">
								<li>
								   <a class="active-menu" href="a.php"> A Tables</a>
								</li>
								<li>
						...
						<li style="font-size: 16px;">
							<a href="closing.php"><i class="fa fa-times fa-2x"></i>CLOSE OPERATION</a>
						</li>						
					</ul>  
				</div>            
			</nav>  
...
FRAG;
																	   echo'<form name="billform" id="form'.$table_no.'" action="a.php" method="post" onsubmit="return check_alert()">';
																	   		echo'<input id="dis" type="button" class="btn btn-success btn-lg launch-modal" data-toggle="modal" data-target="#mydis'.$table_no.'" onclick="showDiv();" style="margin-left: 1%; margin-top: 1%; margin-bottom: 1%; float: left;" value="DISCOUNTS">';
