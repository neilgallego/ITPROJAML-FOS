					...
					<ul class="nav" id="main-menu">
						...
						<li style="font-size: 16px;">
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a class="active-menu" href="b.php">B Tables</a>
								</li>
								<li>
										...
										<div class="table-responsive">
											<?php  
												include "tableB.php";
													...
													$query = "SELECT table_name,table_column FROM table_db where table_column ='B' order BY table_name";
																											...
																											if($result){	
																												echo
																													("<SCRIPT LANGUAGE='JavaScript'>
																													 ...
																													 window.location.href='changeB.php';
																													</SCRIPT>");	
																											}
																										}
																									} 
