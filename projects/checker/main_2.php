...
include ('dbconfig.php');
 ...
 /**if ($t_value == "" || $t_value == "undefined"){
			$t_value = "Select table";
}
if ($w_value == "" || $w_value == "undefined"){
			$w_value = "Select waiter";
}**/
?>
<!DOCTYPE html>
<html>
...
<style>
@media screen and (max-width: 1730px), screen and (max-height: 938px)  {
			...
			<td >
				<div >
					...
					<div style="   
						...
						top: -1px;">
						<a style="   
						background-color: #ffe2e2; color:black;" href="/AMLFOS/AMLFOS/CHECKER/PROTOTYPE2/prototype2/augment/apply/main_2.php"  class="list-group-item list-group-item-warning" data-parent="#SubMenu2" >Happy Hr</a>
					</div> 
					<div style="   
						position: absolute;
					    width: 100px;
		      ...
		      <td rowspan="2"  width="24%" >
				<iframe position: absolute;" frameBorder="0"  height="98.7%" width="100%" style="position:relative; top:0px;" src="order_queue.php" name="iframe_d"></iframe>   
				   ...
				   <div width="100px" height="100px" style=" background-color:black; position:fixed; right:610px; top:990px; z-index: 2; ">
					...
					<div id="clearorder" style="right:0px; top: -120px; z-index:2">
					
					<div class="clear" style="	 position:absolute; top:970px; right:630px; z-index:2">
						...
						<div class="order"  style="	 position:absolute; top:970px; right:500px; z-index:2">
